  ...
  hq: {
    ...
    groups: [
      ...
      { title: '外圍業務', subtotal: '外圍業務',
        items: ['麻醉腸胃鏡', 'ERCP', 'RFA', '心導管室'] }
    ],
    total: { key: '麻醉總數', sum: ['刀房業務', '刀房自費麻醉', '外圍業務'] },
    extras: []
  },
  ak: {
    label: '安康院區',
    groups: [
      { title: '麻醉業務', subtotal: null,
        items: ['半身麻醉(96007)', '硬脊膜麻醉(96005)', '插管全身麻醉(96020)', '插管全身麻醉(96030)', 'LMA(96020)', '未插管全身麻醉(96017)', 'IVG(96004)', '麻醉腸胃鏡', '不插管麻醉'] }
    ],
    total: { key: '麻醉總數',
      sum: ['半身麻醉(96007)', '硬脊膜麻醉(96005)', '插管全身麻醉(96020)', '插管全身麻醉(96030)', 'LMA(96020)', '未插管全身麻醉(96017)', 'IVG(96004)', '麻醉腸胃鏡', '不插管麻醉'] },
    extras: ['RCT', 'ERAS'] // 特殊註記項目，不計入麻醉總數
  }
};
