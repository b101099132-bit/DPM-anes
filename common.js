...
var SITE_UI = {
  ...
  ak: {
    ...
    extras: ['不插管RCT', '所有RCT', '不插管上肢手術', '所有上肢手術', '腸胃鏡工作天數'] // 不計入麻醉總數
  }
};

// 僅管理員可填的欄位（兩院共用，不計入麻醉總數）
var ADMIN_FIELDS = ['一日值班費'];

// ===== 分析報表設定 =====
var GI_TARGET = 15; // 腸胃鏡日均量目標值（台/日），要調整改這裡
// 腸胃鏡合併口徑：歷史用舊單欄，新月份用 4 項相加（自動銜接）
var GI_COLS = ['麻醉腸胃鏡', '麻醉胃鏡(Z6701)', '麻醉大腸鏡(Z6702)', '麻醉腸胃鏡(Z6703)', '麻醉內視鏡超音波(Z6710)'];
