  ...
  ak: {
    ...
    groups: [
      { title: '麻醉業務', subtotal: null,
        items: ['半身麻醉(96007)', '硬脊膜麻醉(96005)', '插管全身麻醉(96020)', '插管全身麻醉(96030)', 'LMA(96020)', '未插管全身麻醉(96017)', 'IVG(96004)', '麻醉腸胃鏡'] }
    ],
    total: { key: '麻醉總數',
      sum: ['半身麻醉(96007)', '硬脊膜麻醉(96005)', '插管全身麻醉(96020)', '插管全身麻醉(96030)', 'LMA(96020)', '未插管全身麻醉(96017)', 'IVG(96004)', '麻醉腸胃鏡'] },
    extras: ['不插管麻醉', 'RCT', 'ERAS'] // 特殊註記項目，不計入麻醉總數
  }
};
